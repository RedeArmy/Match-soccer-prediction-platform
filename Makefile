...
run:
	...
	WCQ_PAYMENT_RECURRENTEAPIKEY=$(WCQ_PAYMENT_RECURRENTEAPIKEY) \
	WCQ_PAYMENT_PAYPALCLIENTID=$(WCQ_PAYMENT_PAYPALCLIENTID) \
	WCQ_PAYMENT_PAYPALCLIENTSECRET=$(WCQ_PAYMENT_PAYPALCLIENTSECRET) \
	WCQ_PAYMENT_PAYPALWEBHOOKID=$(WCQ_PAYMENT_PAYPALWEBHOOKID) \
	WCQ_SERVER_APPBASEURL=$(WCQ_SERVER_APPBASEURL) \
	go run ./cmd/api
