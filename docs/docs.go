...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.reviewBankTransferRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.pollResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/api/v1/admin/match-sync/reconcile": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "API-Football league ID (default: 1)",
                        "name": "league_id",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/internal_api_handler.syncDiffItem"
                            }
                        }
                    },
                    "500": {
        ...
        "/api/v1/admin/match-sync/today": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Kickoff date range end (YYYY-MM-DD, inclusive)",
                        "name": "end_date",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.dailySyncResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/api/v1/admin/matches/{id}/external-link": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Provider and external fixture ID",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.linkExternalRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.linkExternalResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
        ...
        "/api/v1/admin/notification-templates/{event_type}/{locale}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Event type (e.g. payment.confirmed)",
                        "name": "event_type",
                        "in": "path",
                        "required": true
                    },
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.upsertTemplateRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "422": {
                        "description": "Template syntax invalid",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.ErrorResponse"
                        }
                    },
        ...
        "/api/v1/admin/notification-templates/{event_type}/{locale}/preview": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Templates + sample payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.previewTemplateRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.PreviewResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/internal_api_handler.ScoringRuleResponse"
                            }
                        }
                    },
                    "401": {
        ...
        "/api/v1/admin/scoring-rules/{phase}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Tournament phase (e.g. group_stage, round_of_16, final)",
                        "name": "phase",
                        "in": "path",
                        "required": true
                    }
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "New point values",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.updateScoringRuleRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/admin/system-params/{key}/history": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Opaque pagination cursor from prior response",
                        "name": "cursor",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.CursorPaged-internal_api_handler_SystemParamHistoryResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.reviewWithdrawalRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/bank-transfers": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Declared amount in minor currency units",
                        "name": "amount_cents",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Currency code (default GTQ)",
                        "name": "currency",
                        "in": "formData"
                    },
                    {
        ...
        "/api/v1/groups/join-with-balance": {
            "post": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "Insufficient balance or already a member",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.ErrorResponse"
                        }
                    },
        ...
        "/api/v1/predictions": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK (idempotent replay — prediction unchanged)",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.PredictionResponse"
                        }
                    },
                    "201": {
                        "description": "Created (first submission)",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.PredictionResponse"
                        }
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.BalanceResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/api/v1/users/me/balance/ledger": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/internal_api_handler.LedgerEntryResponse"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.createWithdrawalRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_api_handler.BalanceResponse": {
            "type": "object",
            "properties": {
                "available_cents": {
                    "type": "integer"
        ...
        "internal_api_handler.BankTransferResponse": {
            "type": "object",
            "properties": {
                "amount_cents": {
                    "type": "integer"
        ...
        "internal_api_handler.CursorPaged-internal_api_handler_SystemParamHistoryResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api_handler.SystemParamHistoryResponse"
                    }
                },
                "has_more": {
                    "type": "boolean"
        ...
        "internal_api_handler.GroupResponse": {
            ...
            "properties": {
                ...
                "is_premium": {
                    "description": "IsPremium is false for free groups (points-only) and true when at least one\npaid mode is active. Frontend renders this as \"Gratis\" (gray) or \"Premium\" (gold).",
                    "type": "boolean"
                },
                "mode_general": {
                    "description": "ModeGeneral and ModeRound reflect which paid sub-modes are active.",
                    "type": "boolean"
                },
                "mode_round": {
                    "type": "boolean"
        ...
        "internal_api_handler.LedgerEntryResponse": {
            "type": "object",
            "properties": {
                "balance_after": {
                    "type": "integer"
        ...
        "internal_api_handler.PreviewResponse": {
            "type": "object",
            "properties": {
                "action_url": {
                    "type": "string"
        ...
        "internal_api_handler.ScoringRuleResponse": {
            "type": "object",
            "properties": {
                "correct_outcome": {
                    "type": "integer"
        ...
        "internal_api_handler.SystemParamHistoryResponse": {
            "type": "object",
            "properties": {
                "action": {
                    "type": "string"
        ...
        "internal_api_handler.WithdrawalResponse": {
            "type": "object",
            "properties": {
                "amount_cents": {
                    "type": "integer"
        ...
        "internal_api_handler.createWithdrawalRequest": {
            "type": "object",
            "properties": {
                "amount_cents": {
                    "type": "integer"
        ...
        "internal_api_handler.dailySyncResponse": {
            "type": "object",
            "properties": {
                "kickoffs_updated": {
                    "type": "integer"
        ...
        "internal_api_handler.linkExternalRequest": {
            "type": "object",
            "properties": {
                "external_id": {
                    "type": "integer"
        ...
        "internal_api_handler.linkExternalResponse": {
            "type": "object",
            "properties": {
                "external_id": {
                    "type": "integer"
        ...
        "internal_api_handler.pollResponse": {
            "type": "object",
            "properties": {
                "live_count": {
                    "type": "integer"
        ...
        "internal_api_handler.reviewWithdrawalRequest": {
            "type": "object",
            "properties": {
                "notes": {
                    "type": "string"
        ...
        "internal_api_handler.sseStatsResponse": {
            "type": "object",
            "properties": {
                "broadcasts": {
                    "type": "integer"
        ...
        "internal_api_handler.syncDiffItem": {
            "type": "object",
            "properties": {
                "external_away": {
                    "type": "integer"
        ...
        "internal_api_handler.updateScoringRuleRequest": {
            "type": "object",
            "properties": {
                "correct_outcome": {
                    "type": "integer"
        ...
        "internal_api_handler.upsertTemplateRequest": {
            "type": "object",
            "properties": {
                "action_url_tmpl": {
                    "type": "string"
