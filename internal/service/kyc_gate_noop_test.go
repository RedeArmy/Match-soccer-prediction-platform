...
func TestNoopKYCGate_ExceedsAMLThreshold_AlwaysFalse(t *testing.T) {
	exceeds, err := NoopKYCGate{}.ExceedsAMLThreshold(context.Background(), 99_999_999, "GTQ")
	if err != nil || exceeds {
...
func TestNoopKYCGate_ExceedsCumulativeAMLThreshold_AlwaysFalse(t *testing.T) {
	exceeds, err := NoopKYCGate{}.ExceedsCumulativeAMLThreshold(context.Background(), 1, 99_999_999, "GTQ")
	if err != nil || exceeds {
		t.Errorf("expected (false, nil), got (%v, %v)", exceeds, err)
	}
}
...
func TestNoopKYCGate_CheckDepositVelocity_AlwaysNil(t *testing.T) {
	gate := NoopKYCGate{}
	if err := gate.CheckDepositVelocity(context.Background(), 1, 1000, "GTQ"); err != nil {
		t.Errorf("expected nil, got %v", err)
	}
}
...
func TestNoopKYCGate_CheckWithdrawalVelocity_AlwaysNil(t *testing.T) {
	gate := NoopKYCGate{}
	if err := gate.CheckWithdrawalVelocity(context.Background(), 1, 1000, "GTQ"); err != nil {
		t.Errorf("expected nil, got %v", err)
	}
}
