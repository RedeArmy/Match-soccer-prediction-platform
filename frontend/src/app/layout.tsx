...
export const metadata: Metadata = {
  title: "Kiniela",
  description:
    "Predice resultados del torneo internacional de fútbol 2026 y compite en kinielas",
...
const clerkAppearance = {
  ...
  elements: {
    ...
    formButtonPrimary:
      "bg-gradient-to-r from-gold-600 to-gold-300 text-blue-950 font-bold hover:opacity-90",
    footerActionLink: "text-gold-400 hover:text-gold-300",
    formFieldInput:
      "bg-blue-700 border-blue-600 text-white placeholder:text-blue-400/60",
