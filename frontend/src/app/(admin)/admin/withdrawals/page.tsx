...
function ActionModalContent({
  ...
  const config = {
    approve: {
      ...
      required: false,
      warning:
        "La aprobación deducirá el monto del balance disponible del usuario.",
    },
    reject: {
      ...
      required: true,
      warning:
        "El saldo reservado será liberado de vuelta al balance del usuario.",
    },
    process: {
  ...
  return (
    <>
      ...
      <div className="bg-white/5 rounded-lg px-4 py-1">
        ...
        <InfoRow
          label="Destino"
          value={<span className="font-mono text-xs">{destinationLabel}</span>}
        />
...
export default function AdminWithdrawalsPage() {
  ...
  const approveMutation = useMutation({
    ...
    onError: (e: unknown) => {
      setActionError(
        e instanceof Error ? e.message : "Error al aprobar el retiro",
      );
    },
  });
  ...
  const rejectMutation = useMutation({
    ...
    onError: (e: unknown) => {
      setActionError(
        e instanceof Error ? e.message : "Error al rechazar el retiro",
      );
    },
  });
  ...
  const processMutation = useMutation({
    ...
    onError: (e: unknown) => {
      setActionError(
        e instanceof Error ? e.message : "Error al procesar el retiro",
      );
    },
  });
