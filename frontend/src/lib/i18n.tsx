...
const translations: TranslationNode = {
  ...
  landing: {
    // Hero
    eyebrow:         { es: 'Kiniela Internacional · FIFA World Cup 2026',                                                                                                    en: 'International Kiniela · FIFA World Cup 2026'                                                                                                     },
    heroLine1:       { es: 'Kiniela',                                                                                                                                        en: 'World Cup'                                                                                                                                       },
    ...
    scoringSubtitle: { es: 'Cada partido vale. Cuanto más exacta sea tu predicción, más puntos sumas.',                                                                      en: 'Every match counts. The more accurate your prediction, the more points you earn.'                                                              },
    ...
    bonusLabel:      { es: 'Bonus en fases eliminatorias:',                                                                                                                  en: 'Knockout bonus:'                                                                                                                                 },
    bonusCopy:       { es: 'Los puntos por marcador exacto y resultado correcto se multiplican en rondas de 16, cuartos, semifinales y final.',                              en: 'Points for exact score and correct result are multiplied in the round of 16, quarter-finals, semi-finals, and final.'                           },
    // Tournament format
    formatEyebrow:       { es: 'Formato FIFA 2026',                                                                                                                          en: 'FIFA 2026 Format'                                                                                                                                },
    ...
    freeModeDesc:    { es: 'Compite por puntos sin ningún costo. Ideal para seguir el mundial con amigos.',                                                                  en: 'Compete for points at no cost. Perfect for following the World Cup with friends.'                                                                 },
    ...
    techTitle:       { es: 'Construido para el mundial',                                                                                                                     en: 'Built for the World Cup'                                                                                                                         },
