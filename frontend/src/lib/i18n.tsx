...
const translations: TranslationNode = {
  ...
  group: {
    ...
    round2:              { es: 'J2',                          en: 'MD2'                      },
    round3:              { es: 'J3',                          en: 'MD3'                      },
    round4:              { es: '32avos',                      en: 'R32'                      },
    round5:              { es: '16avos',                      en: 'R16'                      },
  ...
  tournaments: {
    ...
    missedPenalty:     { es: 'Penal fallado',                                      en: 'Missed penalty'                                       },
  ...
  predictions: {
    ...
    liveExtraTime:         { es: 'TIEMPO EXTRA',                                                          en: 'EXTRA TIME'                                                       },
    livePenalties:         { es: 'PENALES',                                                               en: 'PENALTIES'                                                        },
    penaltiesScoreLabel:   { es: 'Pen',                                                                   en: 'Pen'                                                              },
    ...
    extraFirstScorer:     { es: 'Primer equipo en anotar',        en: 'First team to score'         },
    extraHalftimeResult:  { es: 'Resultado al medio tiempo',      en: 'Half-time result'             },
    extraHomeTeamScores:  { es: 'Local anota en',                 en: 'Home scores in'                },
    extraAwayTeamScores:  { es: 'Visitante anota en',             en: 'Away scores in'                },
    extraOptionHome:      { es: 'Local',                          en: 'Home'                          },
    extraOptionAway:      { es: 'Visitante',                      en: 'Away'                          },
    extraOptionDraw:      { es: 'Empate',                         en: 'Draw'                          },
    extraOptionNone:      { es: 'Ninguno (0-0)',                  en: 'None (0-0)'                    },
    extraOptionFirstHalf:  { es: 'Primer tiempo',                 en: 'First half'                    },
    extraOptionSecondHalf: { es: 'Segundo tiempo',                en: 'Second half'                   },
    extraOptionBothHalves: { es: 'Ambos tiempos',                 en: 'Both halves'                   },
    extraOptionDoesNotScore: { es: 'No anota',                    en: 'Does not score'                },
    extraPick:            { es: 'Elige...',                       en: 'Pick...'                       },
    extraSaved:           { es: 'Guardado',                       en: 'Saved'                         },
    extraSaveError:       { es: 'No se pudo guardar el extra',    en: 'Could not save the extra'      },
    extraUnavailable:     { es: 'No disponible',                  en: 'Not available'                },
    extraPointsEarned:    { es: 'pts extra',                      en: 'extra pts'                     },
    extraDropdownLabel:   { es: 'Puntos extras',                  en: 'Extra points'                  },
    extraSaveHalftime:    { es: 'Guardar resultado al medio tiempo', en: 'Save half-time result'       },
    extraAuto:            { es: 'auto',                             en: 'auto'                          },
  },
