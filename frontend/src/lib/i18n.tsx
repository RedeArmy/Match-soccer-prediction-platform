...
const translations: TranslationNode = {
  ...
  group: {
    ...
    leaveConfirm:     { es: '¿Seguro que quieres salir? Esta acción no se puede deshacer.', en: 'Are you sure you want to leave? This cannot be undone.' },
  ...
  groups: {
    eyebrow:          { es: 'Quinielas',                        en: 'Pools'                          },
    createTitle:      { es: 'Crear quiniela',                   en: 'Create pool'                    },
    joinTitle:        { es: 'Unirse a quiniela',                en: 'Join pool'                      },
    ...
    entryFeeHint:     { es: 'Deja en 0 para quiniela gratuita', en: 'Set to 0 for a free pool'      },
    inviteCodeLabel:  { es: 'Código de invitación',             en: 'Invite code'                    },
    inviteCodeHint:   { es: 'Comparte este código para que otros se unan a tu quiniela.', en: 'Share this code so others can join your pool.' },
    createAction:     { es: 'Crear quiniela',                   en: 'Create pool'                    },
    joinAction:       { es: 'Unirse',                           en: 'Join'                           },
    createSuccess:    { es: '¡Quiniela creada!',                en: 'Pool created!'                  },
    createError:      { es: 'No se pudo crear la quiniela.',    en: 'Could not create the pool.'     },
